...
public class DoctorsService {
    ...
    public Doctors addNewDoctor(Doctors doctor, String jwt){
    ...
    public Doctors getDoctorById(String id, String jwt){
    ...
    public List<Doctors> getDoctorByName(String name, String jwt){
    ...
    public Doctors updateDoctor(String id, Doctors doctorToUpdate, String jwt){
